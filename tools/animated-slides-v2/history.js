/* ==========================================================================
   Animated Slides v2 — History (undo/redo)
   Deliberately generic — works with any serializable state via a
   getState()/setState() pair, so it isn't tied to CanvasEditor internals
   and could equally undo changes made anywhere else in the tool (slide
   reordering, canvas settings, etc.) later.
